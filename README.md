...
The raw dataset contains 11 features and 1020 entries.`price` is the dependent feature and ramaining are the independent features.
```
...
### Web Scraping :
```bash
Data is scraped from smartpix.com website using selenium library. We try to extract the different features of the laptops such as:
- model name
- price
- score
- processor
...
Scraped dataset have various quality issues and tidiness issues.Please refer data_accessing_and_cleaning.ipynb for more details.
